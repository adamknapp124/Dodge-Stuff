...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""BasicMap"",
            ""id"": ""c182ea00-37d6-4f2d-a34c-812428e3f585"",
            ""actions"": [
                {
                    ""name"": ""Fire"",
                    ""type"": ""Button"",
                    ""id"": ""4d8140ab-44fb-4597-95b9-05361ea3b323"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""96434d82-1f99-4cc3-bb79-9c9a22869b4a"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""04bdfad5-f23d-440a-a6db-c11e3a125839"",
    ...
    ""controlSchemes"": [
        ...
        m_BasicMap_Fire = m_BasicMap.FindAction("Fire", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_BasicMap.enabled, "This will cause a leak and performance issues, InputSystem_Actions.BasicMap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_BasicMap_Fire;
    /// <summary>
    /// Provides access to input actions defined in input action map "BasicMap".
    /// </summary>
    public struct BasicMapActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BasicMapActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "BasicMap/Fire".
        /// </summary>
        public InputAction @Fire => m_Wrapper.m_BasicMap_Fire;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "BasicMap" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BasicMapActions.AddCallbacks(IBasicMapActions)" />
    /// <seealso cref="BasicMapActions.RemoveCallbacks(IBasicMapActions)" />
